...
const ModelInner = ({
    ...
    useFrame((_, dt) => {
        ...
        if (scrollRef && scrollRef.current !== undefined) {
            ...
            if (!isNaN(p)) {
                // Rotate based on scroll progress (e.g., 2 full turns)
        ...
        if (autoRotate && !scrollRef) { // Do not auto-rotate if scrolling
            ...
            >
                ...
                <Suspense fallback={<Loader placeholderSrc={placeholderSrc} />}>
                    <ModelInner
                        ...
                        scrollRef={scrollRef} // Pass it down
                    />
                </Suspense>
